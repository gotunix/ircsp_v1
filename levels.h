...
#define CHAN_OWNER	500
#define CHAN_ADMIN	499
#define CHAN_OPER	350
#define CHAN_VOIC	1
#define CHAN_USER	0
...
#define OPER_LEVEL	1		/* standard oper level */
#define NSERV_ADMIN	250		/* nickserv admin */
#define CSERV_ADMIN	300		/* chanserv admin */
#define SERV_ADMIN	400		/* services admin */
#define ADMIN		800		/* Minion */
#define HEAD_ADMIN	1000		/* G O D */
